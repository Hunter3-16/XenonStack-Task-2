                ...
                <div className='header_options'>
                    ...
                    {auth ?
                        <div className="auth_options">
                            ...
                            <Link className='addStory-link' to="/addstory"><RiPencilFill /> Add New Blog </Link>
                            ...
                            <div className='header-profile-wrapper '>
                                ...
                                {loading ? <SkeletonElement type="minsize-avatar" />
                                    ...
                                    <img src={`https://blogs-backends.onrender.com/userPhotos/${activeUser.photo}`} alt={activeUser.username} />
